        ...
        function saveData() {
            ...
            const requiredFields = ['tanggal', 'shift', 'proses', 'kode', 'sebelum', 'saatini'];
            let isValid = true;
            ...
            // Send data to server
            fetch('../proses/method/create.php', {
                method: 'POST',
                body: formData
            })
        ...
        function editData(id) {
            editIndex = id;
            fetch(`../proses/method/get_data.php?id=${id}`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`../proses/method/delete_data.php`, {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => response.json())
