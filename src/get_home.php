<?php
    ...
    // $query_line = "SELECT id, name, workstation_id FROM line";
    ...
    // Query untuk mengambil data dari tabel `manpower`
    // $query_manpower = "SELECT id_manpower, nama FROM manpower";
    // $result_manpower = mysqli_query($conn, $query_manpower);
    ...
    // Ambil data dari tabel shift
    $query = "SELECT id_shift, shift, jam_kerja FROM shift";
